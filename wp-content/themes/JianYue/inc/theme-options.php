...
$options = array(
    ...
    array(
        'name'  => '百度移动专区天级收录提交',
        'desc'  => '默认不开启，开启后发布文章主动提交，启用后需填写ID和Token值',
        'id'    => "ygj_baiduts",
        'type'  => 'checkbox'
    ),
...
版权声明：本文为转载文章，来源于 文章作者 ，版权归原作者所有，如有侵权请留言告知，谢谢合作！'
    ...
    array(
        ...
        'id'    => "ygj_hdp_lj2",
        'type'  => 'text',
        'std'   => 'https://boke112.com/post/2043.html'
    ),
    array(
        'name'  => '幻灯片二标题',
	...
	array(	"name" => "导航栏下方广告代码（PC端）",
            ...
            "id" => "ygj_addd_c",
            "type" => "textarea",
            "std" => '<a href="http://t.cn/AiehhSJj" target="_blank"><img src="' . get_template_directory_uri() . '/images/abc/yunxiaozhan1100.png" alt="阿里云·云小站，新老用户同享，1核2G云服务器低至89元/年，229元/3年；2核4G3M3年639元" /></a>'),
	...
	array(	"name" => "首页(列表页)第二广告代码（PC端）",
            ...
            "id" => "ygj_adh_cx",
            "type" => "textarea",
            "std" => '<a href="http://t.cn/AiehhSJj" target="_blank"><img src="' . get_template_directory_uri() . '/images/abc/yunxiaozhan.png" alt="阿里云·云小站，新老用户同享，1核2G云服务器低至89元/年，229元/3年；2核4G3M3年639元" /></a>'),
...
<div class="wrap">
    ...
    <div class="ygjtips">    
    <p>当前主题：JianYue&nbsp;1.0&nbsp;版 | 设计者：<a href="https://www.yigujin.cn/2335.html" target="_blank" rel="nofollow noopener">懿古今</a> | <a href="https://www.yigujin.cn/2335.html" target="_blank">加入JianYue主题交流群（431560632）</a> | 建站技术交流请到 <a href="https://boke112.com/" target="_blank" rel="nofollow noopener">boke112联盟</a> | <a href="https://boke112.com/page/youhuihuodong/" target="_blank" rel="nofollow noopener">主机服务器优惠活动</a> </p>
    </div>
	<?php //获取所有站点分类id
...
function ygj_pointer_print_scripts() {
    ...
    jQuery(document).ready(function($) {
        ...
        $menuAppearance.pointer({
            content: '<h3>恭喜，JianYue主题1.0安装成功！</h3><p>该主题支持选项，请访问<a href="themes.php?page=theme-options.php">主题选项</a>页面进行配置。</p>',
            position: {
                edge: "left",
                align: "center"
            },
